...
func loadAuthConfig(serviceConfig *ServiceConfig) (*warehouseConfig.WarehouseConfig, error) {
	cfg := new(warehouseConfig.WarehouseConfig)

	if err := envconfig.Process("warehouse", cfg); err != nil {
		return nil, err
	}
